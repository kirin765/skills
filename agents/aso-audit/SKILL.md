---
name: aso-audit
description: "Audit or optimize an App Store / Google Play listing. Triggers on 'ASO audit', 'app store optimization', 'optimize my app listing', 'app store ranking', 'why aren't people downloading my app', 'keyword optimization for app', 'compare my app to competitors', or an App Store/Play URL the user wants to improve."
metadata:
  version: 1.0.0
---
